-- @description Sélectionner toutes les notes dont la hauteur tonale est inférieure à la note sélectionnée de l'objet sélectionné
-- @version 1.0
...
function main()
  ...
  if notesChanged then
    ...
    speak("Aucune note plus basse trouvée")
  end
