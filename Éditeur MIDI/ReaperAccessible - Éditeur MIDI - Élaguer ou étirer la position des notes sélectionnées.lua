-- @description Élaguer ou étirer la position des notes sélectionnées
-- @version 1.2
...
--   # 2024-09-18 - Ajout d'un log
  ...
  ---------------------------------------------------------------------
  function main()
    local retval, str_user_input = GetUserInputs( 'Étirer la position des notes sélectionnées', 1, '', '*2' )
    if retval then 
      -- form function
        local func
        ...
        reaper.osara_outputMessage("Position des notes étirées")
