-- @description Exporter chaque objet sélectionné vers une instance du RS5K (Mode batterie)
-- @version 1.5
...
local script_title = "Exporter chaque objet sélectionné vers une instance du RS5K (Mode batterie)" 
