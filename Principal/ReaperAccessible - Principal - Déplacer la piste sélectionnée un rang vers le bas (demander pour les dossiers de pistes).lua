...
reaper.Undo_BeginBlock()
    ...
    local function main();
        ...
        local ScrollCheck, Fol_W, GetScrollTr, Undo,Fold_W, wind, block_request,Guid,TrackByGUID,showFold,Cancelled;
        do;-->-0.1
                            ...
                            if Script_Name == "ReaperAccessible - Principal - Déplacer la piste sélectionnée un rang vers le bas (demander pour les dossiers de pistes).lua" then; -->-3.21
                                ...
                                if not wind then;-->-3.1
                                    ...
                                    if wind then;
                                        ...
                                        if MB == 6 then Fol_W = 0; elseif MB == 7 then Fol_W = 1; elseif MB == 2 then Cancelled = true; goto cancel end;
                                    else;
                                        wind = true;
                                    end;
                                end;--<-3.1
        ...
        if not Cancelled then;
            ...
            if tr then;
                ...
                if posBefore and pos == posBefore then;
                    message = name .. " est déjà la dernière piste de la liste"
                else;
                    message = name .. " déplacée vers le bas, piste " .. pos .. " sur " .. total
                end;
